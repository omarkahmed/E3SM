...
#ZE_AFFINITY_MASK=0.0 vtune -collect gpu-offload -r ats-gpu-offload -- ./cpp2d
ZE_AFFINITY_MASK=0.0 vtune -collect gpu-hotspots -r pvc-gpu-hotpspots -- ./cpp2d
cd ..
