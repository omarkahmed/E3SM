if (compile_threaded)
  #string(APPEND CFLAGS   " -fiopenmp -qopenmp-threadprivate=compat -qopenmp-lib=compat")
  string(APPEND CFLAGS   " -fiopenmp -qopenmp-threadprivate=compat")
  #string(APPEND FFLAGS   " -fiopenmp -qopenmp-threadprivate=compat -qopenmp-lib=compat")
  string(APPEND FFLAGS   " -fiopenmp -qopenmp-threadprivate=compat")
  #string(APPEND CXXFLAGS " -fiopenmp -qopenmp-threadprivate=compat -qopenmp-lib=compat")
  string(APPEND CXXFLAGS " -fiopenmp -qopenmp-threadprivate=compat")
  #string(APPEND LDFLAGS  " -fiopenmp -qopenmp-threadprivate=compat -qopenmp-lib=compat")
  string(APPEND LDFLAGS  " -fiopenmp -qopenmp-threadprivate=compat")
endif()
if (NOT DEBUG)
